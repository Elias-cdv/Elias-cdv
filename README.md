...
- 🎓 **Student:** Software Development Engineering at **Brigham Young University-Idaho**.
- 🛠️ **Focus:** Backend Systems (Node.js, PostgreSQL), QA Automation (Python, PyTest), and Object-Oriented Design (C#).
- 🐧 **Environment:** Power Linux user (Ubuntu Server, Bash scripting, system setup).
- 🥋 **Mindset:** Karate instructor — applying discipline, continuous iteration, and focus to technical problem-solving.
...
**Languages & Core**
`Python` · `C#` · `JavaScript (ES6+)` · `SQL` · `Bash`

**Backend & Databases**
`Node.js` · `Express.js` · `PostgreSQL` · `REST APIs` · `EJS`

**QA & Tooling**
`PyTest` · `Postman` · `Git & GitHub` · `GitHub Actions` · `Render` · `Linux (Ubuntu)`
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=Elias-cdv&show_icons=true&theme=tokyonight&hide_border=true" alt="Elias's GitHub Stats" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Elias-cdv&layout=compact&theme=tokyonight&hide_border=true" alt="Top Languages" width="48%" />
</p>
